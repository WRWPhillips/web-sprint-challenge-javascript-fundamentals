...
// nestedFunction is able to access internal because internal is within its syntactic scope
// this is an example of a closure, nestedFunction is able to reach outward to see this
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerCaseArray = array.map(x => x.animal_name.toLowerCase());
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopArray = array.filter(animal => animal.population < 5);
    return lowPopArray;
  }
